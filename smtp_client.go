...
// Dial returns a new Client connected to an SMTP server using TLS at addr.
func DialTLS(localName, addr string) (*Client, error) {
	config := tls.Config{}
	...
	return NewClient(localName, conn, host)
}

// Dial returns a new Client connected to an SMTP server at addr.
// The addr must include a port, as in "mail.example.com:smtp".
func Dial(localName, addr string) (*Client, error) {
...
func NewClient(localName string, conn net.Conn, host string) (*Client, error) {
